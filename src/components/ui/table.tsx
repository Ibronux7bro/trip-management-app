...
>(({ className, ...props }, ref) => (
  <thead 
    ref={ref} 
    className={cn(
      'bg-gradient-to-r from-blue-50 to-indigo-50 [&_tr]:border-b [&_tr]:border-gray-200', 
      className
    )} 
    {...props} 
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      'border-b transition-colors hover:bg-blue-50/50 data-[state=selected]:bg-blue-100',
      className
    )}
    {...props}
  />
