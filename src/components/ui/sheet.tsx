...
>(({ side = 'right', className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ...
      {...props}
    >
      <SheetPrimitive.Close className="absolute right-5 top-5 rounded-full p-1.5 bg-gray-100 opacity-80 ring-offset-background transition-all duration-200 hover:opacity-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-secondary">
...
const SheetFooter = ({
  ...
  <div
    className={cn(
      'flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-3 pt-6 border-t border-gray-100',
      className
    )}
    {...props}
  />
